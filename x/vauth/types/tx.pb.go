...
func (*MsgSubmitProofExternalOwnedAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_d95ded4300ad4b34, []int{0}
}
...
func (*MsgSubmitProofExternalOwnedAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d95ded4300ad4b34, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgSubmitProofExternalOwnedAccount)(nil), "everlast.vauth.v1.MsgSubmitProofExternalOwnedAccount")
	proto.RegisterType((*MsgSubmitProofExternalOwnedAccountResponse)(nil), "everlast.vauth.v1.MsgSubmitProofExternalOwnedAccountResponse")
}

func init() { proto.RegisterFile("everlast/vauth/v1/tx.proto", fileDescriptor_d95ded4300ad4b34) }

var fileDescriptor_d95ded4300ad4b34 = []byte{
	...
	0xbf, 0x77, 0xef, 0xaf, 0x99, 0x34, 0xa1, 0xd1, 0x84, 0x08, 0x89, 0x13, 0x12, 0xcb, 0x31, 0x4e,
	...
	0xff, 0xdb, 0xc2, 0x1e, 0x36, 0x88, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) SubmitProofExternalOwnedAccount(ctx context.Context, in *MsgSubmitProofExternalOwnedAccount, opts ...grpc.CallOption) (*MsgSubmitProofExternalOwnedAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/everlast.vauth.v1.Msg/SubmitProofExternalOwnedAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitProofExternalOwnedAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/everlast.vauth.v1.Msg/SubmitProofExternalOwnedAccount",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "everlast.vauth.v1.Msg",
	...
	Metadata: "everlast/vauth/v1/tx.proto",
}
