...
func (*QueryProofExternalOwnedAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_691f0e531241287d, []int{0}
}
...
func (*QueryProofExternalOwnedAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_691f0e531241287d, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryProofExternalOwnedAccountRequest)(nil), "everlast.vauth.v1.QueryProofExternalOwnedAccountRequest")
	proto.RegisterType((*QueryProofExternalOwnedAccountResponse)(nil), "everlast.vauth.v1.QueryProofExternalOwnedAccountResponse")
}

func init() { proto.RegisterFile("everlast/vauth/v1/query.proto", fileDescriptor_691f0e531241287d) }

var fileDescriptor_691f0e531241287d = []byte{
	// 327 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4d, 0x2d, 0x4b, 0x2d,
	0xca, 0x49, 0x2c, 0x2e, 0xd1, 0x2f, 0x4b, 0x2c, 0x2d, 0xc9, 0xd0, 0x2f, 0x33, 0xd4, 0x2f, 0x2c,
	...
	0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xc8, 0x35, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x64,
	0xce, 0xd8, 0xc6, 0x63, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) ProofExternalOwnedAccount(ctx context.Context, in *QueryProofExternalOwnedAccountRequest, opts ...grpc.CallOption) (*QueryProofExternalOwnedAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/everlast.vauth.v1.Query/ProofExternalOwnedAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ProofExternalOwnedAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/everlast.vauth.v1.Query/ProofExternalOwnedAccount",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "everlast.vauth.v1.Query",
	...
	Metadata: "everlast/vauth/v1/query.proto",
}
